    ...
    <div class="Stories-items">
      <div class="Stories-item">
        <div class="Stories-item-box">
          <img src="https://firebasestorage.googleapis.com/v0/b/changarrito-food-delivery.appspot.com/o/Post%2Favatar.jpg?alt=media&token=1364cab5-372a-4da1-bd6b-30e487ce84cf" alt="utim" />
        </div>
        <h2>
          @Venado1
